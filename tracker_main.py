...
class ObjectTracker:
    def __init__(self, **kwargs):
        ...
        for index, frame in enumerate(video):
            ...
            if counter % 10 == 0:
                trajectories.to_csv('C:\\Users\\WORK-PC\\Desktop\\ml3\\resources\\trajectories.csv', sep=';')
...
class ObjectsCNNRecognizer_CV2():
    ...
    def __init__(self, **kwargs):
        ...
        if self.CNNType=='MobileNET':
            self.prototxt = BaseConfig._base_dir + '/data/MobileNetSSD_deploy.prototxt.txt'
            self.model = BaseConfig._base_dir + '/data/MobileNetSSD_deploy.caffemodel'
            if confidence=='':
            ...
            if confidence=='':
                ...
                self.confidence = float(confidence)
            self.prototxt = BaseConfig._base_dir + '/data/yolo.cfg'
            self.model = BaseConfig._base_dir + '/data/yolov3.weights'
